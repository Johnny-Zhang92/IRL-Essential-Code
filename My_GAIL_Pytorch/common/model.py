...
class QNetwork(nn.Module):
    def __init__(self, num_inputs, num_actions, hidden_dim):
        ...
        self.linear14 = nn.Linear(hidden_dim, hidden_dim)
        self.linear15 = nn.Linear(hidden_dim, 1)
        ...
        self.linear24 = nn.Linear(hidden_dim, hidden_dim)
        self.linear25 = nn.Linear(hidden_dim, 1)
    ...
    def forward(self, state, action):
        ...
        x1 = F.relu(self.linear11(xu))
        x1 = F.relu(self.linear12(x1))
        x1 = F.relu(self.linear13(x1))
        # x1 = F.relu(self.linear14(x1))
        x1 = self.linear15(x1)

        x2 = F.relu(self.linear21(xu))
        x2 = F.relu(self.linear22(x2))
        x2 = F.relu(self.linear23(x2))
        # x2 = F.relu(self.linear24(x2))
        x2 = self.linear25(x2)
