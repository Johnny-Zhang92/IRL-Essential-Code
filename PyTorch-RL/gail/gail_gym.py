...
parser.add_argument('--expert-traj-path', metavar='G', default="assets/expert_traj/Hopper-v2_expert_traj.p",
                    help='path of the expert trajectories', type=str)
...
def main_loop():
    for i_iter in range(args.max_iter_num):
        ...
        if i_iter % args.log_interval == 0:
            print(
                '{}\tT_sample {:.4f}\tT_update {:.4f}\ttrain_discrim_R_avg {:.2f}\ttrain_R_avg {:.2f}\teval_discrim_R_avg {:.2f}\teval_R_avg {:.2f}'.format(
